...
#Initialize lisst and get user input
grades = []
grade = int(input("\nWhat is your first grade (0-100): "))
grades.append(grade)
grade = int(input("What is your second grade (0-100): "))
grades.append(grade)
grade = int(input("What is your thrid grade (0-100): "))
grades.append(grade)
...
print("\nYou grades from highest to lowest are: " + str(grades))

#Removing the lowest two grades
print("\nThe lowest two grades will now be dropped.")
removed_grade = grades.pop()
print("Remove grade: " + str(removed_grade))
removed_grade = grades.pop()
print("Remove grade: " + str(removed_grade))
