...
print("WelcomeWh to the Favorite Teachers Program")
fav_teachers = []
...
print("\nYour to two teachers are: " + fav_teachers[0] + " and " + fav_teachers[1] + ".")
print("Your next two favorite teachers are: " + fav_teachers[2] + " and " + fav_teachers[3] + ".")
print("Your lat favorite teacher is: " + fav_teachers[-1] + ".")
print("You have a total of " + str(len(fav_teachers)) + " favorite teachers.")

#Insert a new favorite teacher
fav_teachers.insert(0, input("\nOops, " + fav_teachers[0] + " is no longer your first favorite teacher. Who is your now FAVORITE teacher: ").title())
...
fav_teachers.remove(input("\nYou decided you no longer like a teacher. Which teacher would you like to remove: ").title())
