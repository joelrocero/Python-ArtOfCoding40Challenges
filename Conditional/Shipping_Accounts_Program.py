...
users = ['eramon', 'footea', 'devisv', 'papinukt', 'allenj']
...
if username in users:
    ...
    print("\nHello " + username + ". Welcome back to you account")
    ...
    bill = quantity*cost
    bill = round(bill, 2)
    print("To ship " + str(quantity) + " items will cost you $" + str(bill) + " at $" + str(cost) + " per items.")
    ...
    if choice.startswith('y'):
        ...
        print("Okay, no order is being place at this time.")
