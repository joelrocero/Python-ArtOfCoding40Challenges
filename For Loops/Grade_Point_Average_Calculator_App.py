#For Loops Challege 15: Grade Point Average Calculator App
...
new_grades = grades[:]
print("\nLets see what your average could have been if you did better/worse on n assignment.")
grade_change = int(input("What grade would you like to change: "))
new_grades.remove(grade_change)
new_grade = int(input("What grade would you like " + str(grade_change) + " to: "))
