...
class Simulation():
    ...
    def __init__(self):
        ...
        #The user did enter a perfect square for the population
            ...
            self.mortality_rate = float(input("---Enter the mortality rate (0-100) the infection: "))
            ...
            for j in range(simulation.grid_size):
                ...
                if self.population[i][j].is_dead == False:
                    ...
                    if i == 0:
                        ...
                        if j == 0:
                            if self.population[i][j+1].is_infected or rself.population[i+1][j].is_infected:
